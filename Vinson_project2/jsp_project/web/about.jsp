...
<html ng-app="myapp">
	<head>
		...
		<title>About - Learninglight</title>
		<style>
			html, body {
				margin: 0;
				padding: 0;
		...
		<div class="container" style="padding-top: 100px">
			<div class="row">
				<div class="col-lg-10 col-lg-offset-2">
					<section>
						<h1>About us</h1>
						<p>Learninglight Virtual Academy was founded in 2008 for providing online IT training in China. This is an online tutorial System for coding developed using MVC model. You can learn by watching video and take an exam here. Enjoy~</p>
					</section>
				</div>
			</div>
		</div>
