...
<%@page import="com.netcourse.entity.Course"%>
...
<%
    ...
    List<Course> courses = c.showCourse();
%>     
<!DOCTYPE html>
<html>
    <head>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="main.jsp"><i class="fa fa-circle-o"></i> Index Board</a></li>
                                <li class="active"><a href="course_manage.jsp"><i class="fa fa-circle-o"></i> Course Edit</a></li> 
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                ...
                                <span>Course</span>
                                <span class="pull-right-container">
                                    <span class="label label-primary pull-right"><%= courseCount%></span>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <c:forEach var="course" items="<%= courses%>">
                                            <tr>
                                                ...
                                                <td><c:out value="${course.CDesc}" /></td>
                                            </tr>
                                        </c:forEach>
                                    </table>
                                </div>
